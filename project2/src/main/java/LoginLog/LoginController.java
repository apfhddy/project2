...
//
//@Controller
//public class LoginController implements ProjectPath{
...
//
//	@RequestMapping("/join")
//	public String join(Model model, Member_DTO vo, HttpServletRequest request) {
//		String msg = null;
//		String ip = getIp(request);
//		vo.setMember_no(loginService.nextSeq());
//		LoginLogVO logvo = new LoginLogVO();
//		logvo.setUserNo(vo.getMember_no());
//		logvo.setIp(ip);
//		logvo.setFailCnt(0);
//		logvo.setStat(0);
...
//	@RequestMapping("/login")
//	@ResponseBody
//	public ResponseEntity<String> checkLogin(HttpServletRequest request, HttpServletResponse response, Member_DTO vo) {
//		String username = vo.getEmail();
