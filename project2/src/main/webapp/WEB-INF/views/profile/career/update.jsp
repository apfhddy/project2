...
<script type="text/javascript">
	function checkWrite(){
		if(document.update.company.value == ""){
			alert("'회사명'란을 채워주세요");
		}else if(document.update.posi.value == ""){
			alert("'직책'란을 채워주세요");
		}else if(document.update.task.value == ""){
			alert("'직무'란을 채워주세요");
		}else{
...
<hr>
<div align="center">
	<form action="${pageContext.request.contextPath }/profile/career_update" method="post" name="update">
		<input type="hidden" value="${vo.CAREER_NO }" name="career_no">

		<table>														
			<tr>
				<th>회사명</th>
				<tr><td><input type="text" name="company" value="${vo.COMPANY }"></td>
			</tr>
			<tr>
				<th>직책</th>
				<tr><td><input type="text" name="posi" value="${vo.POSI }">json 데이터 활용 예정</td>
			</tr>
			<tr>
				<th>직무</th>
				<tr><td><input type="text" name="task" value="${vo.TASK }">json 데이터 활용 예정</td>
			</tr>
			<tr>
				<th>고용형태</th>
				<tr><td>
