							...
							<div class="col-lg-3">
								<aside class="sidebar static">
									...
									<div class="widget stick-widget">
										...
										<ul class="followers">
											<li>
												<figure><img src="${finalPath}resources/images/resources/friend-avatar2.jpg" alt=""></figure>
											...
											<li>
												<figure><img src="${finalPath}resources/images/resources/friend-avatar4.jpg" alt=""></figure>
												<div class="friend-meta">
											...
											<li>
												<figure><img src="${finalPath}resources/images/resources/friend-avatar6.jpg" alt=""></figure>
												<div class="friend-meta">
											...
											<li>
												<figure><img src="${finalPath}resources/images/resources/friend-avatar8.jpg" alt=""></figure>
												<div class="friend-meta">
											...
											<li>
												<figure><img src="${finalPath}resources/images/resources/friend-avatar3.jpg" alt=""></figure>
												<div class="friend-meta">
											...
											<div class="tab-content">
												<div class="tab-pane fade show active" id="basic" >
													<ul class="basics">
														...
														<c:if test="${fn:length(bcontact) != 0 }">
															<c:forEach var="num" items="${bcontact }" >
																<li><i class="ti-mobile"></i>[${num.TYPE}]${num.CONTACT }</li>
															</c:forEach>
														</c:if>
														...
														<c:if test="${fn:length(bpf_url) != 0 }">
															<c:forEach var="url" items="${bpf_url }" >
																<li><i class="ti-world"></i><a href="${url.URL }">[${url.NAME2}] ${url.NAME }</a></li>
															</c:forEach>
														</c:if>
													</ul>
												</div>
							...
							<div class="col-lg-3">
								<aside class="sidebar static">
									<div class="widget">
										...
										<div class="your-page">
											<figure>
												<a href="#" title=""><img style="width: 55px;" src="${finalPath}/resources/profilePicture/${my.logo}" alt=""></a>
											</figure>
											<div class="page-meta">
													...
													<span><i class="ti-heart"></i>884</span>
													  ...
													  <div class="users-thumb-list">
														<a href="#" title="Anderw" data-toggle="tooltip">
															<img src="${finalPath}resources/images/resources/userlist-1.jpg" alt="">  
														</a>
														<a href="#" title="frank" data-toggle="tooltip">
															<img src="${finalPath}resources/images/resources/userlist-2.jpg" alt="">  
														</a>
														<a href="#" title="Sara" data-toggle="tooltip">
															<img src="${finalPath}resources/images/resources/userlist-3.jpg" alt="">  
														</a>
														<a href="#" title="Amy" data-toggle="tooltip">
															<img src="${finalPath}resources/images/resources/userlist-4.jpg" alt="">  
														</a>
														<a href="#" title="Ema" data-toggle="tooltip">
															<img src="${finalPath}resources/images/resources/userlist-5.jpg" alt="">  
														</a>
														<a href="#" title="Sophie" data-toggle="tooltip">
															<img src="${finalPath}resources/images/resources/userlist-6.jpg" alt="">  
														</a>
														<a href="#" title="Maria" data-toggle="tooltip">
															<img src="${finalPath}resources/images/resources/userlist-7.jpg" alt="">  
														</a>  
													  </div>
												  </div>
									...
									<div class="widget">
										<div class="banner medium-opacity bluesh">
											<div class="bg-image" style="background-image: url(${finalPath}resources/images/resources/baner-widgetbg.jpg)"></div>
											<div class="baner-top">
												<span><img alt="" src="${finalPath}resources/images/book-icon.png"></span>
									...
									<div class="widget friend-list stick-widget">
										...
										<ul id="people-list" class="friendz-list">
											<c:forEach items="${createo}" var="co">
												<li>
													<figure>
														<img src="${finalPath}resources/images/resources/friend-avatar.jpg" alt="">
														<span class="status f-online"></span>
													</figure>
													<div class="friendz-meta">
														<a href="time-line.html">${co.NAME} </a>
											...
											<li>
												<figure>
													<img src="${finalPath}resources/images/resources/friend-avatar2.jpg" alt="">
											...
											<li>
												<figure>
													<img src="${finalPath}resources/images/resources/friend-avatar3.jpg" alt="">
											...
											<li>
												<figure>
													<img src="${finalPath}resources/images/resources/friend-avatar4.jpg" alt="">
													<span class="status f-off"></span>
												</figure>
												<div class="friendz-meta">
											...
											<li>
												...
												<figure>
													<img src="${finalPath}resources/images/resources/friend-avatar5.jpg" alt="">
													<span class="status f-online"></span>
												</figure>
												<div class="friendz-meta">
											...
											<li>
												...
												<figure>
													<img src="${finalPath}resources/images/resources/friend-avatar6.jpg" alt="">
													<span class="status f-away"></span>
												</figure>
												<div class="friendz-meta">
											...
											<li>
												...
												<figure>
													<img src="${finalPath}resources/images/resources/friend-avatar7.jpg" alt="">
													<span class="status f-off"></span>
												</figure>
												<div class="friendz-meta">
